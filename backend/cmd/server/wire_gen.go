...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	geminiContextCache := repository.NewGeminiContextCache(redisClient)
	geminiMessagesCompatService := service.NewGeminiMessagesCompatService(accountRepository, groupRepository, gatewayCache, schedulerSnapshotService, geminiTokenProvider, rateLimitService, httpUpstream, geminiContextCache, antigravityGatewayService, configConfig)
